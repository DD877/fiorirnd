		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comtestfiorirnd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtestfiorirnd-display": {
								"semanticObject": "comtestfiorirnd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.test.fiorirnd",
									"url": sap.ui.require.toUrl("com/test/fiorirnd")
								}
							}
						}
					}
