sap.ui.define([
	...
	return BaseController.extend("com.test.fiorirnd.controller.List", {
		...
		onSearch: function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("BusinessPartnerRole", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "com.test.fiorirnd.view.ViewSettingsDialog",
					controller: this
